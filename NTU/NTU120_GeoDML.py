...
from models.RigidNet120_GeoDML import RigidNet120
from models.NonRigidNet120_GeoDML import NonRigidNet120
...
for m in options:
    ...
    for r in range(runs):
        ...
        for dml_run in range(runs):
            ...
            if rigid == True:
                model = RigidNet120(mod,num_frames,num_joints, r, dml_run=dml_run).to(device)
            else:
                model = NonRigidNet120(mod,num_frames,num_joints, r, dml_run=dml_run).to(device)
