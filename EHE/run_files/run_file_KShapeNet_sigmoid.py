...
from models.RigidNet_Kshape import RigidNet
from models.NonRigidNet_KShape import NonRigidNet
...
for ex in range(1,7):
    ...
    save_proba = r'C:\sigmoid\E{}'.format(ex)  # path to save the predicted probabilities from the test set
    ...
    for fold in range(len(os.listdir(folder_path))):
        ...
        for m in options:
            ...
            for r in range(runs):
                ...
                model = model_class(mod=mod,run=r,num_labels=1).to(device)
                ...
                run_test_proba.append(test_proba)
